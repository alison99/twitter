     ...
     try {
       ...
       //  out.println(p_key);
         ...
         //query4 gets total you are following
       	 String query5 = "select username, first_name, last_name, words from user_t, tweet_t, follow_t where user_t.user_id = tweet_t.user_id and tweet_t.user_id = follow_t.`following_id`and follow_t.`followers_id`='" + p_key + "' order by tweet_t.tweet_id desc;";
         //query5 gets tweets         
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					...
					<ul class="nav">
						...
						<li><a href="twitter-signin.jsp">Sign in</a></li>
					</ul>
				</div><!--/ .nav-collapse -->
			</div>
		</div>
                ...
                <div class="module">
                    <div class="content-header">
                        <div class="header-inner">
                            <h2 class="js-timeline-title">Homepage</h2>
                        </div>
                    </div>
					...
					while(rs5.next())
					{
        				...
        				for(int i=0; i<tokens.length; i++) 
        				{
							...
							java.sql.ResultSet rs6 = stmt6.executeQuery(query6);
								...
								//session.setAttribute("hash_id", hash_id);
								output = output + " <a href=twitter-hashtag.jsp?h_key=" + hash_id + ">" + tokens[i]+"</a>";						
								}
							}
							else
							{
						...
						folusername = rs5.getString("username");
						folfullname = rs5.getString("first_name") + " " + rs5.getString("last_name");
