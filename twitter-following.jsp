...
<%
     try {
         ...
         //query4 gets total you are following
       	 String query5 = "select user_t.`user_id`, user_t.`username`, follow_t.`following_id` from user_t join follow_t on user_t.`user_id`=follow_t.`followers_id` where user_t.`user_id`='" + p_key + "' order by followers_id desc;";
         //query5 gets following ids
        ...
        <div class="row">
            ...
            <div class="span8 content-main">
                        ...
                        <div class="flex-module profile-banner-footer clearfix">
                            <div class="default-footer">
                                <ul class="stats js-mini-profile-stats" style="float:left">
                                    <li>
                                        <a class="js-nav" href="twitter-total.jsp">
                                            <strong><%=total%></strong>
                                            Tweets
                                        </a>
                                    </li>
                                    <li>
                                        <a class="js-nav" href="twitter-following.jsp">
                                            <strong><%=following%></strong>
                                            Following
                                        </a>
                                    </li>
                                    <li>
                                        <a class="js-nav" href="twitter-follower.jsp">
				...
				<%
						while(rs5.next())
					{
						fol_id = rs5.getString("following_id");
						java.sql.Statement stmt6 = con.createStatement();
						String query6 = "select user_id, username, first_name, last_name from user_t where user_id ='" + fol_id + "'";

						java.sql.ResultSet rs6 = stmt1.executeQuery(query6);
						if(rs6.next()&&!rs6.getString("username").equals(username)) {
						folusername = rs6.getString("username");
						folfullname = rs6.getString("first_name") + " " + rs6.getString("last_name");
						}
						else break;
                            ...
                            <div class="tweet original-tweet">
                                ...
                                <div class="content">
                                    <div class="stream-item-header">
                                        <a class="account-group">
                                            <img class="avatar" src="images/obama.png" alt="Barak Obama">
                                            <strong class="fullname"><%=folfullname%></strong>
                                            <span>&rlm;</span>
                                            <span class="username">
                                                <s>@</s>
                                                <b><%=folusername%></b>
