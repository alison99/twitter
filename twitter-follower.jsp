...
<%
     try {
         ...
         //query4 gets total you are following
       	 String query5 = "select user_t.`user_id`, user_t.`username`, follow_t.`followers_id` from user_t join follow_t on user_t.`user_id`=follow_t.`following_id` where user_t.`user_id`='" + p_key + "' order by following_id desc;";
         //query5 gets follower ids
        ...
        <div class="row">
            ...
            <div class="span8 content-main">
				...
				<%
					while(rs5.next())
					{
						fol_id = rs5.getString("followers_id");
